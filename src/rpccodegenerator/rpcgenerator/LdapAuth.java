...
public class LdapAuth {
	private final static String ldapURI = "ldap://ldap.iitb.ac.in/ou=People,dc=iitb,dc=ac,dc=in";
	private final static String contextFactory = "com.sun.jndi.ldap.LdapCtxFactory";

	public static DirContext ldapContext () throws Exception {
		Hashtable<String,String> env = new Hashtable <String,String>();
		return ldapContext(env);
	}

	public static DirContext ldapContext (Hashtable <String,String>env) throws Exception {
